/****************************************************************
  ...
  File name: SimpleMessage.idl
  Source: SimpleMessage.hpp
  Cyclone DDS: v0.10.2
...
template <> constexpr const char* TopicTraits<::SimpleMessage::Msg>::getTypeName()
{
  return "SimpleMessage::Msg";
}

template <> constexpr bool TopicTraits<::SimpleMessage::Msg>::isSelfContained()
{
  return false;
}

template <> constexpr bool TopicTraits<::SimpleMessage::Msg>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::SimpleMessage::Msg>::type_map_blob_sz() { return 246; }
template<> constexpr unsigned int TopicTraits<::SimpleMessage::Msg>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::SimpleMessage::Msg>::type_map_blob() {
...
template<> inline const uint8_t * TopicTraits<::SimpleMessage::Msg>::type_info_blob() {
  static const uint8_t blob[] = {
...
template <>
struct topic_type_name<::SimpleMessage::Msg>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::SimpleMessage::Msg>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::SimpleMessage::Msg)
...
template<>
propvec &get_type_props<::SimpleMessage::Msg>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::SimpleMessage::Msg& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::SimpleMessage::Msg& instance, bool as_key) {
  auto &props = get_type_props<::SimpleMessage::Msg>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::SimpleMessage::Msg& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::SimpleMessage::Msg& instance, bool as_key) {
  auto &props = get_type_props<::SimpleMessage::Msg>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::SimpleMessage::Msg& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::SimpleMessage::Msg& instance, bool as_key) {
  auto &props = get_type_props<::SimpleMessage::Msg>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::SimpleMessage::Msg& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::SimpleMessage::Msg& instance, bool as_key) {
  auto &props = get_type_props<::SimpleMessage::Msg>();
