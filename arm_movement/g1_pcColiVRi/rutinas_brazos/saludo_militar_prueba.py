...
class ArmSequence:
    ...
    def LowCmdWrite(self):
        ...
        for joint in self.arm_joints:
            ...
            q_interp = self.interpolate_position(q_init, q_target)
    ...
    def move_to(self, updates: dict, duration=3.0):
...
def main():
    if len(sys.argv) < 2:
        sys.exit("Uso: python3 saludo_militar_prueba.py <interfaz_red>")
    ...
    input("\nPosición inicial: Presiona Enter para llevar los brazos a posición cero...")
    ...
    steps = [
        ...
        ("Paso 3", {
            ...
            G1JointIndex.LeftWristYaw: 0.0,
            G1JointIndex.RightShoulderPitch: 0.0,
            G1JointIndex.RightShoulderRoll: -1.7,
            G1JointIndex.RightShoulderYaw: 0.0,
            G1JointIndex.RightElbow: -0.764,
            G1JointIndex.RightWristRoll: 0.0,
            G1JointIndex.RightWristPitch: 0.0,
            G1JointIndex.RightWristYaw: 0.0,
            G1JointIndex.WaistYaw: 0.0,
        ...
        ("Paso 4", {
            ...
            G1JointIndex.RightShoulderPitch: 0.0,
            G1JointIndex.RightShoulderRoll: -1.7,
            G1JointIndex.RightShoulderYaw: 0.262,
            G1JointIndex.RightElbow: -0.764,
            G1JointIndex.RightWristRoll: 1.08,
            G1JointIndex.RightWristPitch: 0.0,
            G1JointIndex.RightWristYaw: 0.0,
            G1JointIndex.WaistYaw: 0.0,
            G1JointIndex.WaistRoll: 0.0,
        ...
        ("Paso 5", {
            ...
            G1JointIndex.LeftWristPitch: 0.0,
            G1JointIndex.LeftWristYaw: 0.0,
            G1JointIndex.RightShoulderPitch: -1.22,
            G1JointIndex.RightShoulderRoll: -1.7,
            G1JointIndex.RightShoulderYaw: 0.262,
            G1JointIndex.RightElbow: -0.764,
            G1JointIndex.RightWristRoll: 1.08,
    ...
    for i, (label, targets) in enumerate(steps):
        input(f"\n{label}: Presiona Enter para continuar...")
        seq.move_to(targets)
        if i == 4:
            print("Manteniendo posición de saludo militar durante 10 segundos...")
            time.sleep(10)

    input("\nRutina completada. Presiona Enter para finalizar el script.")
