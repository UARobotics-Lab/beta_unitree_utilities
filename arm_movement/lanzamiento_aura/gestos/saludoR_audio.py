...
if __name__ == "__main__":
    command = ["~/play_wav_request","--if=~/Music/Aura/hola2.wav"]
    hilo = threading.Thread(target=play_audio, args=(command,3))
    #proceso = subprocess.run(command, capture_output=True)
    hilo.start()
    #print(proceso)
    main()
